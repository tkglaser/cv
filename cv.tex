...
\cvitem{}{I'm passionate about applying technology to solve real-world problems and guiding a business to success.}
\cvitem{}{My 22-year experience as a Full Stack Software Engineer, Architect, Trainer and Team Lead gives me not only the deep and broad technical knowledge needed to create robust system designs but also the interpersonal skills to guide business stakeholders, build and manage a team and mentor developers as an ongoing process. I have been labeled as an excellent communicator and someone that is easy to work with.}
...
\cvitem{Programming}{C\#, .NET, Typescript, React, AWS, SQL / NoSQL, etc.}
...
\section[\faIcon{chart-bar}]{Skill matrix}
...
\cvskillentry{}{4}{C\#}{12}{Used in various projects in different companies}
\cvskillentry{}{2}{Python}{2}{Basic experience, mainly with AI projects}
